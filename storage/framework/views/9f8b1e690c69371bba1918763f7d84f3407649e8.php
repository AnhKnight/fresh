...
<html lang="<?php echo e(locale()); ?>">
    <head>
        ...
        <title>
            <?php echo $__env->yieldContent('title'); ?> - Fresh
        </title>
    ...
    <body class="skin-blue sidebar-mini offcanvas clearfix <?php echo e(is_rtl() ? 'rtl' : 'ltr'); ?>">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                <?php echo $__env->make('admin::partials.top_nav', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
